...
{
    public abstract class MobileBEWorkshopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MobileBEWorkshopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MobileBEWorkshopWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MobileBEWorkshopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MobileBEWorkshopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MobileBEWorkshopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MobileBEWorkshopDbContext, Task<T>> func)
        {
            T result;
