...
{
    [DbContext(typeof(MobileBEWorkshopDbContext))]
    [Migration("20210604013206_Add assignment #2")]
    partial class Addassignment2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobileBEWorkshop.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MobileBEWorkshop.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MobileBEWorkshop.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MobileBEWorkshop.Workshops.Departments.Department", b =>
                {
                    ...
                    b.ToTable("Workshop_Departments");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MobileBEWorkshop.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MobileBEWorkshop.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MobileBEWorkshop.Authorization.Roles.Role", b =>
                {
                    b.HasOne("MobileBEWorkshop.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("MobileBEWorkshop.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("MobileBEWorkshop.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
