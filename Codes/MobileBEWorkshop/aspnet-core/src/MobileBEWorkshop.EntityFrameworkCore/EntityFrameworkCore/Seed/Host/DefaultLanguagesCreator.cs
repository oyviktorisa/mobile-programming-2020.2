...
namespace MobileBEWorkshop.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MobileBEWorkshopConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MobileBEWorkshopDbContext context)
        {
            _context = context;
        }
